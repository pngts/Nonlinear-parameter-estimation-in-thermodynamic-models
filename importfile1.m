function [TK1,Pbar,Y1,X1,Y2,X2] = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   [TK1,PBAR,Y1,X1,Y2,X2] = IMPORTFILE1(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   [TK1,PBAR,Y1,X1,Y2,X2] = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [TK1,Pbar,Y1,X1,Y2,X2] = importfile1('TERNARY.DAT',3, 53);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/09/25 17:16:29
